...
void System::addUser() {
    ...
    std::string name = ui.dialogueEx("To add new user: \nEnter name: ");
...
void System::addProd(Warehouse &warehouse) {
    ...
    std::string name = ui.dialogueEx("To ADD new product, enter the name: ");
    std::string category = ui.dialogueEx("category: ");
